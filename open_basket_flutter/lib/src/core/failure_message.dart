...
String errorMessage(AppLocalizations l10n, BasketError error) =>
    switch (error) {
      ...
      BasketError.householdCodeRotated => l10n.errorHouseholdCodeRotated,
      BasketError.tooManyJoinAttempts => l10n.errorTooManyJoinAttempts,
      ...
      BasketError.invalidDeviceToken => l10n.errorInvalidDeviceToken,
